  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
      ...
      <div className="md:w-1/6">
        <button
          type="button"
          className="bg-sky-700 text-white flex gap-2 px-5 py-3 rounded-md font-bold uppercase shadow-md w-full"
        ...
        <button
          type="button"
          className="bg-red-700 text-white flex gap-2 px-5 py-3 rounded-md font-bold uppercase shadow-md w-full mt-3"
